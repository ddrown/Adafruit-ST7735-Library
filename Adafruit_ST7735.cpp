...
//      SPDR = c;
//      while(!(SPSR & _BV(SPIF)));
#elif defined (__STM32F1__) || defined(ESP8266)
      SPI.write(c);
...
inline void Adafruit_ST7735::repeatcolor(uint16_t color, uint16_t times) {
...
#else
#error "Unknown platform - SPI not initialized"
#endif
  } else {
